...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameStatsManager> : ModifyBase<ModifyDerive<Der, GameStatsManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, canItemBeUnlocked, , int, UnlockType)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, createReward, , GJRewardType, int, gd::string)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, createSpecialChestItems, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, encodeDataTo, , DS_Dictionary*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, getNextGoldChestID, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, getSecretOnlineRewardKey, , int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, isStoreItemUnlocked, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, keyCostForSecretChest, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, linkSpecialChestUnlocks, , GJRewardItem*, gd::string)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, postLoadGameStats, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, processOnlineChests, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, purchaseItem, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, recountSpecialStats, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, resetSpecialChest, , gd::string)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, storeEventChest, , int, GJRewardItem*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, storeOnlineChest, , gd::string, GJRewardItem*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, trySelectActivePath, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, unlockGoldChest, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameStatsManager, unlockOnlineChest, , gd::string)
