...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJBaseGameLayer> : ModifyBase<ModifyDerive<Der, GJBaseGameLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJBaseGameLayer, toggleHideAttempts, , bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x23b8c0, Thiscall, GJBaseGameLayer, activateSongEditTrigger, SongTriggerGameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJBaseGameLayer, activateSongTrigger, , SongTriggerGameObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJBaseGameLayer, moveObjectToStaticGroup, , GameObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJBaseGameLayer, processSongState, , int, float, float, int, float, float, gd::vector<SongTriggerState>*, SongTriggerGameObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJBaseGameLayer, resetSongTriggerValues, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJBaseGameLayer, resumeAudio, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJBaseGameLayer, updateCollisionBlocks, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6da50, Thiscall, GJBaseGameLayer, updateOBB2, cocos2d::CCRect)
