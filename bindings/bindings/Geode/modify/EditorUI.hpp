...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EditorUI> : ModifyBase<ModifyDerive<Der, EditorUI>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11dcd0, Thiscall, EditorUI, colorSelectClosed, cocos2d::ccColor3B)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x120dd0, Thiscall, EditorUI, constrainGameLayerPosition, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x10fc60, Thiscall, EditorUI, deselectObject, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditorUI, editObject2, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x121690, Thiscall, EditorUI, findSnapObject, cocos2d::CCArray*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x121790, Thiscall, EditorUI, findSnapObject, cocos2d::CCPoint, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11e000, Thiscall, EditorUI, moveObjectCall, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditorUI, onCopy, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditorUI, onPaste, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditorUI, orderDownCustomItem, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditorUI, orderUpCustomItem, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11e7b0, Thiscall, EditorUI, transformObjectCall, cocos2d::CCObject*)
