...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LevelInfoLayer> : ModifyBase<ModifyDerive<Der, LevelInfoLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelInfoLayer, confirmOwnerDelete, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelInfoLayer, playStep2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelInfoLayer, playStep3, )
