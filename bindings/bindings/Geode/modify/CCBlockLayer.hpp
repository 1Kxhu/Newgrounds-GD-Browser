...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCBlockLayer> : ModifyBase<ModifyDerive<Der, CCBlockLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCBlockLayer, ccTouchBegan, , cocos2d::CCTouch*, cocos2d::CCEvent*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCBlockLayer, decrementForcePrio, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCBlockLayer, incrementForcePrio, )
		}
	};
}
