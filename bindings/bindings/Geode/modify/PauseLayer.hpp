...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PauseLayer> : ModifyBase<ModifyDerive<Der, PauseLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(PauseLayer, createToggleButton, , gd::string, cocos2d::SEL_MenuHandler, bool, cocos2d::CCMenu*, cocos2d::CCPoint)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(PauseLayer, onHelp, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(PauseLayer, onRecordReplays, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(PauseLayer, onReplay, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(PauseLayer, onTime, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3687e0, Thiscall, PauseLayer, onTryEdit, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(PauseLayer, setupProgressBars, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(PauseLayer, tryShowBanner, , float)
		}
	};
}
