...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PlayLayer> : ModifyBase<ModifyDerive<Der, PlayLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3cef0, Thiscall, PlayLayer, getTempMilliTime, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(PlayLayer, prepareMusic, , bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(PlayLayer, toggleDebugDraw, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(PlayLayer, toggleGhostEffect, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(PlayLayer, toggleIgnoreDamage, , bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x394a40, Thiscall, PlayLayer, updateTimeWarp, EffectGameObject*, float)
		}
	};
}
