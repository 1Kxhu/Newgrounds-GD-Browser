...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PlayerObject> : ModifyBase<ModifyDerive<Der, PlayerObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(PlayerObject, levelFlipping, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(PlayerObject, levelWillFlip, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(PlayerObject, limitDashRotation, , float&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3775c0, Thiscall, PlayerObject, runRotateAction, bool, int)
