...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, TOSPopup> : ModifyBase<ModifyDerive<Der, TOSPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TOSPopup, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TOSPopup, onPrivacy, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TOSPopup, onTOS, , cocos2d::CCObject*)
		}
	};
}
