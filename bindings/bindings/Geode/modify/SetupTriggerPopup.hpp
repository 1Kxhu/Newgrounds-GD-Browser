...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTriggerPopup, getGroupContainer, , int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTriggerPopup, onMultiTrigger, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTriggerPopup, toggleEaseRateVisibility, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTriggerPopup, updateEaseLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTriggerPopup, updateEaseRateLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTriggerPopup, updateEditorLabel, )
