...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ShardsPage> : ModifyBase<ModifyDerive<Der, ShardsPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShardsPage, FLAlert_Clicked, , FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShardsPage, goToPage, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShardsPage, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x474610, Thiscall, ShardsPage, onIconInfo, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShardsPage, onSwitchPage, , cocos2d::CCObject*)
		}
	};
}
