...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameObject> : ModifyBase<ModifyDerive<Der, GameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addColorSpriteToParent, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addColorSpriteToSelf, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addCustomBlackChild, , gd::string, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addCustomChild, , gd::string, cocos2d::CCPoint, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addCustomColorChild, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addEmptyGlow, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x18af60, Thiscall, GameObject, addGlow, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addInternalChild, , cocos2d::CCSprite*, gd::string, cocos2d::CCPoint, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addInternalCustomColorChild, , gd::string, cocos2d::CCPoint, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addInternalGlowChild, , gd::string, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addNewSlope01, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addNewSlope01Glow, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addNewSlope02, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addNewSlope02Glow, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addRotation, , float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addRotation, , float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addToColorGroup, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addToCustomScaleX, , float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addToCustomScaleY, , float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addToOpacityGroup, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addToTempOffset, , double, double)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, assignUniqueID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, belongsToGroup, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, calculateOrientedBox, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, canChangeCustomColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, canChangeMainColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, canChangeSecondaryColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, canRotateFree, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, colorForMode, , int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, commonInteractiveSetup, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, createColorGroupContainer, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, createGlow, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(GameObject, createGroupContainer, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, createOpacityGroupContainer, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, createSpriteColor, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, deselectObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x199340, Thiscall, GameObject, determineSlopeDirection, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, didScaleXChange, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, didScaleYChange, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, dirtifyObjectPos, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, dirtifyObjectRect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, disableObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, dontCountTowardsLimit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, duplicateAttributes, , GameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, duplicateColorMode, , GameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x19ee40, Thiscall, GameObject, duplicateValues, GameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, editorColorForCustomMode, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x19e0a0, Thiscall, GameObject, editorColorForMode, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, fastRotateObject, , float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getActiveColorForMode, , int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getBallFrame, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getBoundingRect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getBoxOffset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getColorFrame, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getColorIndex, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getColorKey, , bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getCustomZLayer, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getGlowFrame, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getGroupDisabled, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getGroupID, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getGroupString, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getLastPosition, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getMainColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getMainColorMode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getObjectDirection, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getObjectRadius, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getObjectRectPointer, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getObjectZLayer, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getObjectZOrder, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getOuterObjectRect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getParentMode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x19eb30, Thiscall, GameObject, getRelativeSpriteColor, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getScalePosDelta, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getSecondaryColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getSecondaryColorMode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getSlopeAngle, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getUnmodifiedPosition, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, groupColor, , cocos2d::ccColor3B const&, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x199d30, Thiscall, GameObject, groupOpacityMod, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, groupWasDisabled, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, groupWasEnabled, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, hasSecondaryColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, ignoreEditorDuration, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, ignoreEnter, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, ignoreFade, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(GameObject, init, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, isBasicEnterEffect, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, isBasicTrigger, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, isColorObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, isColorTrigger, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, isConfigurablePortal, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, isEditorSpawnableTrigger, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, isSettingsObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x19f730, Thiscall, GameObject, isSpawnableTrigger, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, isSpecialObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, isSpeedObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, isStoppableTrigger, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x19f2c0, Thiscall, GameObject, isTrigger, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, loadGroupsFromString, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, makeInvisible, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, makeVisible, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, opacityModForMode, , int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, parentForZLayer, , int, bool, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, perspectiveColorFrame, , char const*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, perspectiveFrame, , char const*, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, quickUpdatePosition, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, quickUpdatePosition2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, removeColorSprite, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, removeGlow, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, reorderColorSprite, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, resetColorGroups, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, resetGroupDisabled, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, resetGroups, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, resetMainColorMode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, resetMID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, resetMoveOffset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, resetRScaleForced, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, resetSecondaryColorMode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, setAreaOpacity, , float, float, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, setCustomZLayer, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, setDefaultMainColorMode, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, setDefaultSecondaryColorMode, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, setGlowOpacity, , unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, setLastPosition, , cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, setMainColorMode, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, setSecondaryColorMode, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, setupColorSprite, , int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, setupPixelScale, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, setupSpriteSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, shouldBlendColor, , GJSpriteColor*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, shouldLockX, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, shouldNotHideAnimFreeze, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, shouldShowPickupEffects, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, slopeFloorTop, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, slopeWallLeft, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x19e430, Thiscall, GameObject, slopeYPos, cocos2d::CCRect)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x19e430, Thiscall, GameObject, slopeYPos, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, slopeYPos, , GameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, spawnDefaultPickupParticle, , GJBaseGameLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, updateBlendMode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, updateCustomColorType, , short)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, updateHSVState, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x19e7b0, Thiscall, GameObject, updateIsOriented, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, updateMainColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, updateMainColorOnly, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, updateMainOpacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x19e370, Thiscall, GameObject, updateObjectEditorColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, updateSecondaryColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, updateSecondaryColorOnly, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, updateSecondaryOpacity, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, updateStartPos, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, updateUnmodifiedPositions, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, usesFreezeAnimation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, usesSpecialAnimation, )
		}
	};
}
