...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ChallengesPage> : ModifyBase<ModifyDerive<Der, ChallengesPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x85300, Thiscall, ChallengesPage, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x425d0, Thiscall, ChallengesPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x86980, Thiscall, ChallengesPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x867a0, Thiscall, ChallengesPage, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(ChallengesPage, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x85db0, Thiscall, ChallengesPage, challengeStatusFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x85f40, Thiscall, ChallengesPage, challengeStatusFailed, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x86cc0, Thiscall, ChallengesPage, currencyWillExit, CurrencyRewardLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x869d0, Thiscall, ChallengesPage, claimItem, ChallengeNode*, GJChallengeItem*, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x86090, Thiscall, ChallengesPage, createChallengeNode, int, bool, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x863c0, Thiscall, ChallengesPage, exitNodeAtSlot, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x86940, Thiscall, ChallengesPage, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ChallengesPage, tryGetChallenges, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ChallengesPage, updateDots, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x864b0, Thiscall, ChallengesPage, updateTimers, float)
		}
	};
}
