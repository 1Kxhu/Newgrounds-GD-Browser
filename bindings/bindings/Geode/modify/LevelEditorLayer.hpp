...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LevelEditorLayer> : ModifyBase<ModifyDerive<Der, LevelEditorLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2d5f10, Thiscall, LevelEditorLayer, timeForPos, cocos2d::CCPoint, int, int, bool, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2d5f80, Thiscall, LevelEditorLayer, posForTime, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x22b740, Thiscall, LevelEditorLayer, dirtifyTriggers, )
