...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameLevelManager> : ModifyBase<ModifyDerive<Der, GameLevelManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, createAndGetMapPacks, , gd::string)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, getCompletedDailyLevels, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, getCompletedEventLevels, , int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, getCompletedGauntletDemons, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, getCompletedGauntletLevels, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x145860, Thiscall, GameLevelManager, getCompletedLevels, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, getCompletedWeeklyLevels, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, getDemonLevelsString, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, getDescKey, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, getDifficultyStr, , bool, bool, bool, bool, bool, bool, bool, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, getGJSecretReward, , gd::string)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, getLocalLevelList, , int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, getStarLevelsString, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, hasRatedLevelStars, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, hasReportedLevel, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, invalidateMessages, , bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, invalidateRequests, , bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x160840, Thiscall, GameLevelManager, invalidateUserList, UserListType, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, isDLActive, , char const*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, onGetGJSecretRewardCompleted, , gd::string, gd::string)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, removeDLFromActive, , char const*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, resetCommentTimersForAccountID, , int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, resetTimerForKey, , char const*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, setDiffVal, , int, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, setLenVal, , int, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameLevelManager, verifyContainerOnlyHasLevels, , cocos2d::CCDictionary*)
