...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EditLevelLayer> : ModifyBase<ModifyDerive<Der, EditLevelLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0xd3c10, Thiscall, EditLevelLayer)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditLevelLayer, confirmClone, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditLevelLayer, onClone, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditLevelLayer, onDelete, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditLevelLayer, onEdit, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditLevelLayer, onMoveToTop, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditLevelLayer, onTest, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditLevelLayer, onUpdateDescription, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditLevelLayer, playStep2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditLevelLayer, playStep3, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd5720, Thiscall, EditLevelLayer, setupLevelInfo, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditLevelLayer, updateDescText, , char const*)
