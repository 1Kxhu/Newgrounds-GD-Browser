...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCSpriteWithHue> : ModifyBase<ModifyDerive<Der, CCSpriteWithHue>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCSpriteWithHue, createWithSpriteFrameName, , gd::string const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48c20, Thiscall, CCSpriteWithHue, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x485f0, Thiscall, CCSpriteWithHue, initWithTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48650, Thiscall, CCSpriteWithHue, initWithTexture, cocos2d::CCTexture2D*, cocos2d::CCRect const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48590, Thiscall, CCSpriteWithHue, initWithTexture, cocos2d::CCTexture2D*, cocos2d::CCRect const&, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48660, Thiscall, CCSpriteWithHue, initWithSpriteFrame, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48400, Thiscall, CCSpriteWithHue, getShaderName, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48900, Thiscall, CCSpriteWithHue, shaderBody, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48910, Thiscall, CCSpriteWithHue, updateColor, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x486d0, Thiscall, CCSpriteWithHue, initShader, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48930, Thiscall, CCSpriteWithHue, updateColorMatrix, )
