...
private:
    [[deprecated("SecretRewardsLayer::fadeInMusic not implemented")]]
    /**
     * @note[short] Android
     */
...
private:
    [[deprecated("SecretRewardsLayer::fadeInOutMusic not implemented")]]
    /**
     * @note[short] Android
     */
...
private:
    [[deprecated("SecretRewardsLayer::updateUnlockedGoldLabel not implemented")]]
    /**
     * @note[short] Android
     */
